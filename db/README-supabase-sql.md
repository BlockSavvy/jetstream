# Setting Up JetStream Database in Supabase

Since the automated migration scripts are encountering SSL certificate issues, we need to set up the database manually through the Supabase SQL Editor.

## Steps:

1. Log in to your Supabase dashboard at: https://app.supabase.com/
2. Navigate to your JetStream project
3. Click on "SQL Editor" in the left sidebar
4. Create a new query and paste the contents of the `sql-for-editor.sql` file
5. Run the query to create all the tables, triggers, and policies

## Running the Seed Script

After setting up the database schema, you can run the seed script to populate the database with test data:
...
Once the schema and seed data are set up, you can verify the setup by:

1. Going to the "Table Editor" in the Supabase dashboard
2. Checking that all tables (profiles, jets, airports, flights, bookings, etc.) have been created
3. Checking that the tables have been populated with the seed data
