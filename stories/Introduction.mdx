...
2. **JetShare Mobile App** - A mobile-first application focused on peer-to-peer jet cost sharing, allowing users to offset private aviation costs by sharing flights with others. This app is our primary launch focus.
...
- **Context-Aware Assistance** - Adapts behavior based on whether it's used in JetShare, main platform, or backend contexts
...
- **JetShare Mobile App** - Our primary launch focus with mobile-optimized components:
  - Listing management
  - Seat selection
  - Booking workflow
  - Payment processing
